...
## StudioLayout
App shell for /studio/* — desktop rail + phone strip + bottom hub bar + Outlet.
...
\\n
## StudioHubShell / StudioScrollPane / StudioWorkSurface
...
\\n
## PublicLayout note
Public site uses a separate PublicLayout; Studio is the design target here.
