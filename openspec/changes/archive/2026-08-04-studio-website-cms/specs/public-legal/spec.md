...
The system SHALL provide a Privacy page whose body content is managed from Website Site chrome (with a Soft night–suitable default when empty), explaining what inquiry/booking data is collected and how it is used.
