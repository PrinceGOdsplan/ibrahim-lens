/** VAPID + Web Push send (CommonJS — require from handlers). */
const ece = require(`${__hooks}/ece.js`)
const eceHkdf = ece.eceHkdf
const eceAesGcmEncrypt = ece.eceAesGcmEncrypt
const eceBytesToSendBody = ece.eceBytesToSendBody
